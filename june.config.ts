...
// target is just the adapter. clientRouter turns same-origin links into MORPH
// navigations: the header island's state survives, the agent surface stays whole.
